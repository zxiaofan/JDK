...
class CharacterData01 extends CharacterData {
  ...
  // java GenerateCharacter -string -plane 1 -template t:/workspace/open/make/data/characterdata/CharacterData01.java.template -spec t:/workspace/open/make/data/unicodedata/UnicodeData.txt -specialcasing t:/workspace/open/make/data/unicodedata/SpecialCasing.txt -proplist t:/workspace/open/make/data/unicodedata/PropList.txt -derivedprops t:/workspace/open/make/data/unicodedata/DerivedCoreProperties.txt -o t:/workspace/build/windows-x64-open/support/gensrc/java.base/java/lang/CharacterData01.java -usecharforbyte 11 4 1
