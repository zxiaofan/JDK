...
public final class plugins extends ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "generate-jli-classes.ignore.version.warn", "WARNING: --generate-jli-classes set to ignore version mismatch between \nJDK running jlink and target image." },
            { "generate-jli-classes.version.mismatch.warn", "WARNING: Pre-generation of JLI classes is only supported when linking \nthe same version of java.base ({0}) as the JDK running jlink ({1}), \nclass generation skipped - specify ignore-version to override." },
