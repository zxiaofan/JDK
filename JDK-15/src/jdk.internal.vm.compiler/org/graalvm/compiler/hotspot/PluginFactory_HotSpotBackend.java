...
//        class: org.graalvm.compiler.hotspot.HotSpotBackend
//       method: unsafeArraycopyStub(org.graalvm.compiler.core.common.spi.ForeignCallSignature,org.graalvm.compiler.word.Word,org.graalvm.compiler.word.Word,org.graalvm.compiler.word.Word)
// generated-by: org.graalvm.compiler.replacements.processor.GeneratedNodeIntrinsicPlugin$CustomFactoryPlugin
final class Plugin_HotSpotBackend_unsafeArraycopyStub extends GeneratedInvocationPlugin {
    ...
    public boolean execute(GraphBuilderContext b, ResolvedJavaMethod targetMethod, InvocationPlugin.Receiver receiver, ValueNode[] args) {
        ...
        org.graalvm.compiler.core.common.spi.ForeignCallSignature arg2;
        if (args[0].isConstant()) {
            arg2 = snippetReflection.asObject(org.graalvm.compiler.core.common.spi.ForeignCallSignature.class, args[0].asJavaConstant());
        } else {
            assert b.canDeferPlugin(this) : b.getClass().toString();
            return false;
        }
...
public class PluginFactory_HotSpotBackend implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        ...
        plugins.register(new Plugin_HotSpotBackend_unsafeArraycopyStub(injection), org.graalvm.compiler.hotspot.HotSpotBackend.class, "unsafeArraycopyStub", org.graalvm.compiler.core.common.spi.ForeignCallSignature.class, org.graalvm.compiler.word.Word.class, org.graalvm.compiler.word.Word.class, org.graalvm.compiler.word.Word.class);
