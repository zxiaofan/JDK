...
final class Plugin_ArrayCopyCallNode_arraycopy__1 extends GeneratedInvocationPlugin {
    ...
    public boolean execute(GraphBuilderContext b, ResolvedJavaMethod targetMethod, InvocationPlugin.Receiver receiver, ValueNode[] args) {
        ...
        if (args[6].isConstant()) {
            arg8 = snippetReflection.asObject(jdk.vm.ci.meta.JavaKind.class, args[6].asJavaConstant());
        } else {
            assert b.canDeferPlugin(this) : b.getClass().toString();
            return false;
        }
        ...
        if (args[7].isConstant()) {
            arg9 = snippetReflection.asObject(jdk.vm.ci.meta.JavaKind.class, args[7].asJavaConstant());
        } else {
            assert b.canDeferPlugin(this) : b.getClass().toString();
            return false;
        }
        ...
        org.graalvm.compiler.replacements.arraycopy.ArrayCopyCallNode node = new org.graalvm.compiler.replacements.arraycopy.ArrayCopyCallNode(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13);
        b.add(node);
        return true;
    }
    @Override
...
// generated-by: org.graalvm.compiler.replacements.processor.GeneratedNodeIntrinsicPlugin$ConstructorPlugin
final class Plugin_ArrayCopyCallNode_arraycopy__2 extends GeneratedInvocationPlugin {
    ...
    Plugin_ArrayCopyCallNode_arraycopy__2(NodeIntrinsicPluginFactory.InjectionProvider injection) {
        this.snippetReflection = injection.getInjectedArgument(org.graalvm.compiler.api.replacements.SnippetReflectionProvider.class);
        this.injectedArrayCopyForeignCalls = injection.getInjectedArgument(org.graalvm.compiler.replacements.arraycopy.ArrayCopyForeignCalls.class);
        this.injectedWordTypes = injection.getInjectedArgument(org.graalvm.compiler.word.WordTypes.class);
    }
...
public class PluginFactory_ArrayCopyCallNode implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        ...
        plugins.register(new Plugin_ArrayCopyCallNode_arraycopy__1(injection), org.graalvm.compiler.replacements.arraycopy.ArrayCopyCallNode.class, "arraycopy", java.lang.Object.class, int.class, java.lang.Object.class, int.class, int.class, jdk.vm.ci.meta.JavaKind.class, jdk.vm.ci.meta.JavaKind.class, jdk.vm.ci.meta.JavaKind.class, boolean.class, boolean.class, boolean.class, int.class);
        plugins.register(new Plugin_ArrayCopyCallNode_arraycopy__2(injection), org.graalvm.compiler.replacements.arraycopy.ArrayCopyCallNode.class, "arraycopy", java.lang.Object.class, int.class, java.lang.Object.class, int.class, int.class, jdk.vm.ci.meta.JavaKind.class, jdk.internal.vm.compiler.word.LocationIdentity.class, boolean.class, boolean.class, boolean.class, int.class);
    }
}
