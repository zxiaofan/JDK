    ...
    public Iterator<OptionDescriptor> iterator() {
        return new Iterator<OptionDescriptor>() {
            ...
            public OptionDescriptor next() {
                switch (i++) {
                    case 0: return get("InlineDuringParsing");
                    case 1: return get("InlineDuringParsingMaxDepth");
                    case 2: return get("InlineIntrinsicsDuringParsing");
                    case 3: return get("InlinePartialIntrinsicExitDuringParsing");
                    case 4: return get("TraceBytecodeParserLevel");
                    case 5: return get("TraceInlineDuringParsing");
                    case 6: return get("TraceParserPlugins");
                }
