...
public final class compiler extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "compiler.err.cant.inherit.from.sealed", "class is not allowed to extend sealed class: {0}" },
            ...
            { "compiler.err.local.classes.cant.extend.sealed", "local classes must not extend sealed classes" },
