    ...
    public OptionDescriptor get(String value) {
        ...
        case "CompilationBailoutAction": {
            return OptionDescriptor.create(
                ...
                /*type*/ org.graalvm.compiler.core.CompilationWrapper.ExceptionAction.class,
        ...
        case "CrashAt": {
            return OptionDescriptor.create(
                /*name*/ "CrashAt",
                /*type*/ String.class,
                /*help*/ "Pattern for method(s) that will trigger an exception when compiled. This option exists to test handling compilation crashes gracefully. See the MethodFilter option for the pattern syntax. ",
                /*declaringClass*/ GraalCompilerOptions.class,
                /*fieldName*/ "CrashAt",
