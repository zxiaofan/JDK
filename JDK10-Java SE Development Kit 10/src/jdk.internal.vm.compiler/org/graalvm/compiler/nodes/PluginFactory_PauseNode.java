...
public class PluginFactory_PauseNode implements NodeIntrinsicPluginFactory {
    ...
    private static final class PauseNode_pause extends GeneratedInvocationPlugin {
    ...
    public void registerPlugins(InvocationPlugins plugins, InjectionProvider injection) {
        plugins.register(new PauseNode_pause(), org.graalvm.compiler.nodes.PauseNode.class, "pause");
    }
}
