...
public class PluginFactory_HotSpotReplacementsUtil implements NodeIntrinsicPluginFactory {
    ...
    //        class: org.graalvm.compiler.hotspot.replacements.HotSpotReplacementsUtil
    //       method: arrayBaseOffset(jdk.vm.ci.meta.JavaKind)
    // generated-by: org.graalvm.compiler.replacements.verifier.GeneratedFoldPlugin
    private static final class HotSpotReplacementsUtil_arrayBaseOffset extends GeneratedInvocationPlugin {
        ...
        public boolean execute(GraphBuilderContext b, ResolvedJavaMethod targetMethod, InvocationPlugin.Receiver receiver, ValueNode[] args) {
            ...
            int result = org.graalvm.compiler.hotspot.replacements.HotSpotReplacementsUtil.arrayBaseOffset(arg0);
            JavaConstant constant = JavaConstant.forInt(result);
            ConstantNode node = ConstantNode.forConstant(constant, b.getMetaAccess(), b.getGraph());
            b.push(JavaKind.Int, node);
            b.notifyReplacedCall(targetMethod, node);
        ...
        private HotSpotReplacementsUtil_arrayBaseOffset(InjectionProvider injection) {
    ...
    //        class: org.graalvm.compiler.hotspot.replacements.HotSpotReplacementsUtil
    //       method: arrayIndexScale(jdk.vm.ci.meta.JavaKind)
    // generated-by: org.graalvm.compiler.replacements.verifier.GeneratedFoldPlugin
    private static final class HotSpotReplacementsUtil_arrayIndexScale extends GeneratedInvocationPlugin {
        ...
        public boolean execute(GraphBuilderContext b, ResolvedJavaMethod targetMethod, InvocationPlugin.Receiver receiver, ValueNode[] args) {
            ...
            int result = org.graalvm.compiler.hotspot.replacements.HotSpotReplacementsUtil.arrayIndexScale(arg0);
            JavaConstant constant = JavaConstant.forInt(result);
            ConstantNode node = ConstantNode.forConstant(constant, b.getMetaAccess(), b.getGraph());
            b.push(JavaKind.Int, node);
            b.notifyReplacedCall(targetMethod, node);
    ...
    private static final class HotSpotReplacementsUtil_loadKlassFromObjectIntrinsic extends GeneratedInvocationPlugin {
        ...
        public boolean execute(GraphBuilderContext b, ResolvedJavaMethod targetMethod, InvocationPlugin.Receiver receiver, ValueNode[] args) {
            ...
            if (args[2].isConstant()) {
                arg3 = snippetReflection.asObject(org.graalvm.word.LocationIdentity.class, args[2].asJavaConstant());
            } else {
                return false;
            }
    ...
    // generated-by: org.graalvm.compiler.replacements.verifier.GeneratedFoldPlugin
    private static final class HotSpotReplacementsUtil_objectAlignment extends GeneratedInvocationPlugin {
        ...
        private HotSpotReplacementsUtil_objectAlignment(InjectionProvider injection) {
            this.injectedGraalHotSpotVMConfig = injection.getInjectedArgument(org.graalvm.compiler.hotspot.GraalHotSpotVMConfig.class);
        }
    }
    ...
    public void registerPlugins(InvocationPlugins plugins, InjectionProvider injection) {
        ...
        plugins.register(new HotSpotReplacementsUtil_arrayBaseOffset(injection), org.graalvm.compiler.hotspot.replacements.HotSpotReplacementsUtil.class, "arrayBaseOffset", jdk.vm.ci.meta.JavaKind.class);
        ...
        plugins.register(new HotSpotReplacementsUtil_arrayIndexScale(injection), org.graalvm.compiler.hotspot.replacements.HotSpotReplacementsUtil.class, "arrayIndexScale", jdk.vm.ci.meta.JavaKind.class);
        ...
        plugins.register(new HotSpotReplacementsUtil_loadKlassFromObjectIntrinsic(injection), org.graalvm.compiler.hotspot.replacements.HotSpotReplacementsUtil.class, "loadKlassFromObjectIntrinsic", java.lang.Object.class, long.class, org.graalvm.word.LocationIdentity.class, jdk.vm.ci.meta.JavaKind.class);
        plugins.register(new HotSpotReplacementsUtil_loadWordFromObjectIntrinsic(injection), org.graalvm.compiler.hotspot.replacements.HotSpotReplacementsUtil.class, "loadWordFromObjectIntrinsic", java.lang.Object.class, long.class, org.graalvm.word.LocationIdentity.class, jdk.vm.ci.meta.JavaKind.class);
        ...
        plugins.register(new HotSpotReplacementsUtil_objectAlignment(injection), org.graalvm.compiler.hotspot.replacements.HotSpotReplacementsUtil.class, "objectAlignment", org.graalvm.compiler.hotspot.GraalHotSpotVMConfig.class);
