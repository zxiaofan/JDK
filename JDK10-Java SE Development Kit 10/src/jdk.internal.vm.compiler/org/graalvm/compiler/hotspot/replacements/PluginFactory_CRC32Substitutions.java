...
public class PluginFactory_CRC32Substitutions implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, InjectionProvider injection) {
        ...
        plugins.register(new CRC32Substitutions_updateBytesCRC32(injection), org.graalvm.compiler.hotspot.replacements.CRC32Substitutions.class, "updateBytesCRC32", org.graalvm.compiler.core.common.spi.ForeignCallDescriptor.class, int.class, org.graalvm.word.WordBase.class, int.class);
    }
}
