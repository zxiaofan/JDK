...
public class CompilerProperties {
    public static class Errors {
         ...
         */
        public static Error IllegalRefToVarType(Name arg0) {
            return new Error("compiler", "illegal.ref.to.var.type", arg0);
        }
         ...
         */
        public static Error VarNotAllowed(TokenKind arg0) {
            return new Error("compiler", "var.not.allowed", arg0);
        }
