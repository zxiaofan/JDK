    ...
    static {
        ...
        */
        ...
        resourceNameToLocales.put("LocaleNames",
                                  "  ar be bg ca cs da de el el-CY en-MT en-PH en-SG es es-US et fi fr ga he hi hr hu id is it ja ko lt lv mk ms mt nb nb-NO nl nn-NO no no-NO-NY pl pt pt-BR pt-PT ro ru sk sl sq sr sr-Latn sv th tr uk vi zh zh-HK zh-Hans-SG zh-Hant-HK zh-Hant-TW zh-SG zh-TW ");
        ...
        resourceNameToLocales.put("CalendarData",
                                  "  ar be bg ca cs da de el el-CY en-GB en-IE en-MT es es-ES es-US et fi fr fr-CA he hi hr hu id-ID is it ja ko lt lv mk ms-MY mt mt-MT nb nb-NO nl nn-NO no pl pt pt-BR pt-PT ro ru sk sl sq sr sr-Latn-BA sr-Latn-ME sr-Latn-RS sv th tr uk vi zh ");
