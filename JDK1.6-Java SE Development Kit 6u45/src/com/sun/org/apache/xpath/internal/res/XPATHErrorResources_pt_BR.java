...
public static final String ER_IGNORABLE_WHITESPACE_NOT_HANDLED = 
 ...
 public static final String ER_ONLY_ALLOWS = "ER_ONLY_ALLOWS";
  ...
  { ER_CURRENT_NOT_ALLOWED_IN_MATCH, "A fun\u00e7\u00e3o current() n\u00e3o \u00e9 permitida em um padr\u00e3o correspondente!" },

  { ER_CURRENT_TAKES_NO_ARGS, "A fun\u00e7\u00e3o current() n\u00e3o aceita a argumentos!" },
  ...
  { ER_TRANSLATE_TAKES_3_ARGS,
      "A fun\u00e7\u00e3o translate() usa tr\u00eas argumentos!"},

  { ER_UNPARSEDENTITYURI_TAKES_1_ARG,
      "A fun\u00e7\u00e3o unparsed-entity-uri deve usar um argumento!"},

  { ER_NAMESPACEAXIS_NOT_IMPLEMENTED,
      "eixo do namespace ainda n\u00e3o implementado!"},
  ...
  { ER_INCORRECT_ARG_LENGTH,
      "A largura do argumento do teste do n\u00f3 processing-instruction() \u00e9 incorreta!"},

  { ER_CANT_CONVERT_TO_NUMBER,
      "N\u00e3o \u00e9 poss\u00edvel converter {0} em um n\u00famero"},

  { ER_CANT_CONVERT_TO_NODELIST,
      "N\u00e3o \u00e9 poss\u00edvel converter {0} em um NodeList!"},

  { ER_CANT_CONVERT_TO_MUTABLENODELIST,
      "N\u00e3o \u00e9 poss\u00edvel converter {0} em um NodeSetDTM!"},

  { ER_CANT_CONVERT_TO_TYPE,
      "N\u00e3o \u00e9 poss\u00edvel converter {0} em um type#{1}"},

  { ER_EXPECTED_MATCH_PATTERN,
      "Padr\u00e3o de correspond\u00eancia esperado em getMatchScore!"},

  { ER_COULDNOT_GET_VAR_NAMED,
      "N\u00e3o foi poss\u00edvel obter a vari\u00e1vel nomeada {0}"},

  { ER_UNKNOWN_OPCODE,
     "ERRO! C\u00f3digo de opera\u00e7\u00e3o desconhecido: {0}"},

  { ER_EXTRA_ILLEGAL_TOKENS,
     "Tokens adicionais ilegais: {0}"},

  { ER_EXPECTED_DOUBLE_QUOTE,
      "literal com aspas incorretas... espera-se aspas duplas!"},

  { ER_EXPECTED_SINGLE_QUOTE,
      "literal com aspas incorretas... espera-se aspas simples!"},

  { ER_EMPTY_EXPRESSION,
     "Express\u00e3o vazia!"},

  { ER_EXPECTED_BUT_FOUND,
     "{0} esperado, mas encontrado: {1}"},

  { ER_INCORRECT_PROGRAMMER_ASSERTION,
      "A afirma\u00e7\u00e3o do programador \u00e9 incorreta! - {0}"},

  { ER_BOOLEAN_ARG_NO_LONGER_OPTIONAL,
      "O argumento boolean(...) n\u00e3o \u00e9 mais opcional com o rascunho XPath 19990709."},

  { ER_FOUND_COMMA_BUT_NO_PRECEDING_ARG,
      "Encontrado '','' mas sem argumento anterior!"},

  { ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG,
      "Encontrado '','' mas sem argumento seguinte!"},

  { ER_PREDICATE_ILLEGAL_SYNTAX,
      "''..[predicado]'' ou ''.[predicado]'' \u00e9 uma sintaxe ilegal.  Em vez disso, use ''self::node()[predicado]''."},

  { ER_ILLEGAL_AXIS_NAME,
     "nome de eixo ilegal: {0}"},

  { ER_UNKNOWN_NODETYPE,
     "Tipo de n\u00f3 desconhecido: {0}"},

  { ER_PATTERN_LITERAL_NEEDS_BE_QUOTED,
      "A literal de padr\u00e3o ({0}) precisar estar entre aspas!"},

  { ER_COULDNOT_BE_FORMATTED_TO_NUMBER,
      "{0} n\u00e3o p\u00f4de ser formato para um n\u00famero!"},
  ...
  { ER_ILLEGAL_VARIABLE_REFERENCE,
      "VariableReference dada \u00e0 vari\u00e1vel est\u00e1 fora de contexto ou sem defini\u00e7\u00e3o!  Nome = {0}"},

  { ER_AXES_NOT_ALLOWED,
      "Somente eixos child:: e attribute:: s\u00e3o permitidos em padr\u00f5es de correspond\u00eancia!  Eixos incorretos = {0}"},

  { ER_KEY_HAS_TOO_MANY_ARGS,
      "key() possui um n\u00famero incorreto de argumentos."},

  { ER_COUNT_TAKES_1_ARG,
      "A fun\u00e7\u00e3o count deve usar um argumento!"},

  { ER_COULDNOT_FIND_FUNCTION,
     "N\u00e3o foi poss\u00edvel encontrar a fun\u00e7\u00e3o: {0}"},

  { ER_UNSUPPORTED_ENCODING,
     "Codifica\u00e7\u00e3o n\u00e3o suportada: {0}"},

  { ER_PROBLEM_IN_DTM_NEXTSIBLING,
      "O problema ocorreu no DTM em getNextSibling... tentando recuperar"},

  { ER_CANNOT_WRITE_TO_EMPTYNODELISTIMPL,
      "Erro do programador: n\u00e3o \u00e9 poss\u00edvel gravar em EmptyNodeList."},
  ...
  { ER_PARSE_NOT_SUPPORTED,
      "an\u00e1lise (fonte InputSource) n\u00e3o suportada em XPathContext! N\u00e3o \u00e9 poss\u00edvel abrir {0}"},

  { ER_SAX_API_NOT_HANDLED,
      "SAX API characters(char ch[]... n\u00e3o manipulado pelo DTM!"},

  { ER_IGNORABLE_WHITESPACE_NOT_HANDLED,
      "ignorableWhitespace(char ch[]... n\u00e3o manipulado pelo DTM!"},

  { ER_DTM_CANNOT_HANDLE_NODES,
      "DTMLiaison n\u00e3o pode manipular n\u00f3s de tipo {0}"},

  { ER_XERCES_CANNOT_HANDLE_NODES,
      "DOM2Helper n\u00e3o pode manipular n\u00f3s de tipo {0}"},
  ...
  { ER_CANNOT_CREATE_URL,
     "N\u00e3o \u00e9 poss\u00edvel criar url para: {0}"},

  { ER_XPATH_READOBJECT,
     "Em XPath.readObject: {0}"},

  { ER_FUNCTION_TOKEN_NOT_FOUND,
      "token de fun\u00e7\u00e3o n\u00e3o encontrado."},

  { ER_CANNOT_DEAL_XPATH_TYPE,
       "N\u00e3o \u00e9 poss\u00edvel solucionar o tipo XPath: {0}"},
  ...
  { ER_VAR_NOT_RESOLVABLE,
        "Vari\u00e1vel n\u00e3o solucion\u00e1vel: {0}"},

  { ER_NULL_ERROR_HANDLER,
        "Manipulador de erros nulo"},

  { ER_PROG_ASSERT_UNKNOWN_OPCODE,
       "Afirma\u00e7\u00e3o do programador: c\u00f3digo de opera\u00e7\u00e3o desconhecido: {0}"},
  ...
  { ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS,
       "fsb() n\u00e3o suportado por XStringForChars"},

  { ER_COULD_NOT_FIND_VAR,
      "N\u00e3o foi poss\u00edvel encontrar a vari\u00e1vel com o nome de {0}"},

  { ER_XSTRINGFORCHARS_CANNOT_TAKE_STRING,
      "XStringForChars n\u00e3o pode obter uma sequ\u00eancia para um argumento"},
  ...
  { ER_VARIABLE_ACCESSED_BEFORE_BIND,
       "Vari\u00e1vel acessada antes de ser vinculada!"},

  { ER_FSB_CANNOT_TAKE_STRING,
       "XStringForFSB n\u00e3o pode obter uma sequ\u00eancia para um argumento!"},

  { ER_SETTING_WALKER_ROOT_TO_NULL,
       "\n !!!! Erro! Definindo a raiz de um walker como nula!!!"},

  { ER_NODESETDTM_CANNOT_ITERATE,
       "Este NodeSetDTM n\u00e3o pode se repetir em um n\u00f3 anterior!"},

  { ER_NODESET_CANNOT_ITERATE,
       "Este NodeSet n\u00e3o pode se repetir em um n\u00f3 anterior!"},

  { ER_NODESETDTM_CANNOT_INDEX,
       "Este NodeSetDTM n\u00e3o pode fazer indexa\u00e7\u00e3o ou somar fun\u00e7\u00f5es!"},

  { ER_NODESET_CANNOT_INDEX,
       "Este NodeSet n\u00e3o pode fazer indexa\u00e7\u00e3o ou somar fun\u00e7\u00f5es!"},

  { ER_CANNOT_CALL_SETSHOULDCACHENODE,
       "N\u00e3o \u00e9 poss\u00edvel chamar setShouldCacheNodes depois que nextNode tiver sido chamado!"},

  { ER_ONLY_ALLOWS,
       "{0} somente permite {1} argumentos"},

  { ER_UNKNOWN_STEP,
       "Afirma\u00e7\u00e3o do programador em getNextStepPos: stepType desconhecido: {0}"},

  //Note to translators:  A relative location path is a form of XPath expression.
  // The message indicates that such an expression was expected following the
  // characters '/' or '//', but was not found.
  { ER_EXPECTED_REL_LOC_PATH,
      "Esperava-se um caminho de localiza\u00e7\u00e3o relativo depois do token ''/'' ou ''//''."},

  // Note to translators:  A location path is a form of XPath expression.
  // The message indicates that syntactically such an expression was expected,but
  // the characters specified by the substitution text were encountered instead.
  { ER_EXPECTED_LOC_PATH,
       "Esperava-se um caminho de localiza\u00e7\u00e3o, mas o token seguinte foi encontrado:  {0}"},

  // Note to translators:  A location path is a form of XPath expression.
  // The message indicates that syntactically such a subexpression was expected,
  // but no more characters were found in the expression.
  { ER_EXPECTED_LOC_PATH_AT_END_EXPR,
       "Esperava-se um caminho de localiza\u00e7\u00e3o, mas, em vez disso, encontrou-se o final da express\u00e3o XPath."},

  // Note to translators:  A location step is part of an XPath expression.
  // The message indicates that syntactically such an expression was expected
  // following the specified characters.
  { ER_EXPECTED_LOC_STEP,
       "Esperava-se a etapa de localiza\u00e7\u00e3o depois do token ''/'' ou ''//''."},
  ...
  { ER_EXPECTED_NODE_TEST,
       "Esperava-se um teste de n\u00f3 que correspondesse a NCName:* ou QName."},

  // Note to translators:  A step pattern is part of an XPath expression.
  // The message indicates that syntactically such an expression was expected,
  // but the specified character was found in the expression instead.
  { ER_EXPECTED_STEP_PATTERN,
       "Esperava-se um padr\u00e3o de etapa, mas encontrou-se '/'."},
  ...
  { ER_CANT_CONVERT_TO_BOOLEAN,
       "O XPathResult da express\u00e3o XPath ''{0}'' possui um XPathResultType de {1} que n\u00e3o pode ser convertido em um booleano."},

  // Note to translators: Do not translate ANY_UNORDERED_NODE_TYPE and 
  // FIRST_ORDERED_NODE_TYPE.
  { ER_CANT_CONVERT_TO_SINGLENODE,
       "O XPathResult da express\u00e3o XPath ''{0}'' possui um XPathResultType de {1} que n\u00e3o pode ser convertido em um n\u00f3 simples. O m\u00e9todo getSingleNodeValue se aplica somente a tipos ANY_UNORDERED_NODE_TYPE e FIRST_ORDERED_NODE_TYPE."},
  ...
  { ER_EMPTY_XPATH_RESULT,
       "Objeto Result de XPath vazio"},

  { ER_INCOMPATIBLE_TYPES,
       "O XPathResult da express\u00e3o XPath ''{0}'' possui um XPathResultType de {1} que n\u00e3o pode estar delimitado dentro do XPathResultType especificado de {2}."},

  { ER_NULL_RESOLVER,
       "N\u00e3o \u00e9 poss\u00edvel resolver prefixo com solucionador de prefixo nulo."},

  // Note to translators:  The substitution text is the name of a data type.  The
  // message indicates that a value of a particular type could not be converted
  // to a value of type string.
  { ER_CANT_CONVERT_TO_STRING,
       "O XPathResult da express\u00e3o XPath ''{0}'' possui um XPathResultType de {1} que n\u00e3o pode ser convertido em uma sequ\u00eancia."},
  ...
  { ER_CANT_CONVERT_XPATHRESULTTYPE_TO_NUMBER,
	"O XPathResult da express\u00e3o XPath ''{0}'' possui um XPathResultType de {1} que n\u00e3o pode ser convertido em um n\u00famero."},       
  ...
  { ER_SOURCE_RETURN_TYPE_CANNOT_BE_NULL,
       "O tipo de fonte e/ou retorno n\u00e3o pode ser nulo"},
  ...
  { WG_LOCALE_NAME_NOT_HANDLED,
      "nome da localidade na fun\u00e7\u00e3o format-number ainda n\u00e3o manipulado!"},

  { WG_PROPERTY_NOT_SUPPORTED,
      "Propriedade XSL n\u00e3o suportada: {0}"},

  { WG_DONT_DO_ANYTHING_WITH_NS,
      "N\u00e3o fazer nada atualmente com o namespace {0} na propriedade: {1}"},
  ...
  { WG_EXPAND_ENTITIES_NOT_SUPPORTED,
      "Op\u00e7\u00e3o -E n\u00e3o suportada para o analisador DTM"},
