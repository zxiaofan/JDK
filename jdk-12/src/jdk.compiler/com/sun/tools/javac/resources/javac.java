...
public final class javac extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "javac.opt.release", "Compile for a specific release. Supported releases: {0}" },
            { "javac.opt.s", "Emit java sources instead of classfiles" },
            { "javac.opt.source", "Provide source compatibility with specified release. Supported releases: {0}" },
            ...
            { "javac.opt.target", "Generate class files for specific VM version. Supported versions: {0}" },
