    ...
    public OptionDescriptor get(String value) {
        ...
        case "CompilerConfiguration": {
            return OptionDescriptor.create(
                ...
                /*help*/ "Names the Graal compiler configuration to use. If omitted, the compiler configuration with the highest auto-selection priority is used. To see the set of available configurations, supply the value 'help' to this option.",
