    ...
    public OptionDescriptor get(String value) {
        ...
        case "MaxCompilationProblemsPerAction": {
            return OptionDescriptor.create(
                ...
                /*help*/ "The maximum number of compilation failures or bailouts to handle with the action specified by CompilationFailureAction or CompilationBailoutAction before changing to a less verbose action. This does not apply to the ExitVM action.",
                /*declaringClass*/ GraalCompilerOptions.class,
