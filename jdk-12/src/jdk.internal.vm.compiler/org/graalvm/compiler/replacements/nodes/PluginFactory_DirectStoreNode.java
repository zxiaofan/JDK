...
final class Plugin_DirectStoreNode_storeBoolean extends GeneratedInvocationPlugin {
    ...
    Plugin_DirectStoreNode_storeBoolean(NodeIntrinsicPluginFactory.InjectionProvider injection) {
...
public class PluginFactory_DirectStoreNode implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        plugins.register(new Plugin_DirectStoreNode_storeBoolean(injection), org.graalvm.compiler.replacements.nodes.DirectStoreNode.class, "storeBoolean", long.class, boolean.class, jdk.vm.ci.meta.JavaKind.class);
    }
}
