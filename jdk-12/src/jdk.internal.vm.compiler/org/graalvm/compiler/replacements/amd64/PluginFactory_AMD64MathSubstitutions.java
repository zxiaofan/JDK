...
final class Plugin_AMD64MathSubstitutions_callDouble1 extends GeneratedInvocationPlugin {
    ...
    Plugin_AMD64MathSubstitutions_callDouble1(NodeIntrinsicPluginFactory.InjectionProvider injection) {
...
// generated-by: org.graalvm.compiler.replacements.processor.GeneratedNodeIntrinsicPlugin$CustomFactoryPlugin
final class Plugin_AMD64MathSubstitutions_callDouble2 extends GeneratedInvocationPlugin {
    ...
    Plugin_AMD64MathSubstitutions_callDouble2(NodeIntrinsicPluginFactory.InjectionProvider injection) {
        this.injectedForeignCallsProvider = injection.getInjectedArgument(org.graalvm.compiler.core.common.spi.ForeignCallsProvider.class);
        this.snippetReflection = injection.getInjectedArgument(org.graalvm.compiler.api.replacements.SnippetReflectionProvider.class);
        this.stamp = injection.getInjectedStamp(double.class, false);
    }
...
public class PluginFactory_AMD64MathSubstitutions implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        plugins.register(new Plugin_AMD64MathSubstitutions_callDouble1(injection), org.graalvm.compiler.replacements.amd64.AMD64MathSubstitutions.class, "callDouble1", org.graalvm.compiler.core.common.spi.ForeignCallDescriptor.class, double.class);
        plugins.register(new Plugin_AMD64MathSubstitutions_callDouble2(injection), org.graalvm.compiler.replacements.amd64.AMD64MathSubstitutions.class, "callDouble2", org.graalvm.compiler.core.common.spi.ForeignCallDescriptor.class, double.class, double.class);
    }
}
