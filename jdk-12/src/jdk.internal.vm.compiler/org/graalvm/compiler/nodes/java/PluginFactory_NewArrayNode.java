...
public class PluginFactory_NewArrayNode implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        plugins.register(new Plugin_NewArrayNode_newArray(), org.graalvm.compiler.nodes.java.NewArrayNode.class, "newArray", java.lang.Class.class, int.class, boolean.class);
    }
}
