...
final class LocaleEquivalentMaps {
    ...
    static {
        ...
        regionVariantEquivMap.put("-arevela", "-hy");
        regionVariantEquivMap.put("-arevmda", "-hyw");
        ...
        regionVariantEquivMap.put("-hy", "-arevela");
        regionVariantEquivMap.put("-hyw", "-arevmda");
