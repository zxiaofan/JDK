...
public final class standard extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "doclet.help.class_interface.summary", "Each summary entry contains the first sentence from the detailed description for that item. The summary entries are alphabetical, while the detailed descriptions are in the order they appear in the source code. This preserves the logical groupings established by the programmer." },
            { "doclet.help.constants.body", "The {0} page lists the static final fields and their values." },
            { "doclet.help.deprecated.body", "The {0} page lists all of the API that have been deprecated. A deprecated API is not recommended for use, generally due to improvements, and a replacement API is usually given. Deprecated APIs may be removed in future implementations." },
            ...
            { "doclet.help.frames.body", "These links show and hide the HTML frames.  All pages are available with or without frames." },
            { "doclet.help.frames.head", "Frames/No Frames" },
