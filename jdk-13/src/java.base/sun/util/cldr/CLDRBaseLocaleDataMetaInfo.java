    ...
    static {
        ...
        parentLocalesMap.put(Locale.ROOT,
             new String[] {
                 ...
                 "ff-Arab", "ha-Arab", "iu-Latn", "kk-Arab", "ku-Arab", "ky-Arab", 
                 "ky-Latn", "ml-Arab", "mn-Mong", "ms-Arab", "pa-Arab", "sd-Deva", 
                 "sd-Khoj", "sd-Sind", "shi-Latn", "so-Arab", "sr-Latn", "sw-Arab", 
                 "tg-Arab", "ug-Cyrl", "uz-Arab", "uz-Cyrl", "vai-Latn", "wo-Arab", 
                 "yo-Arab", "yue-Hans", "zh-Hant", 
             });
        ...
        parentLocalesMap.put(Locale.forLanguageTag("en-150"),
             new String[] {
                ...
                languageAliasMap.put("cel-gaulish", "xtg-x-cel-gaulish");
