...
final class Plugin_ThreadSubstitutions_threadIsInterruptedStub extends GeneratedInvocationPlugin {
    ...
    Plugin_ThreadSubstitutions_threadIsInterruptedStub(NodeIntrinsicPluginFactory.InjectionProvider injection) {
...
public class PluginFactory_ThreadSubstitutions implements NodeIntrinsicPluginFactory {
    ...
    public void registerPlugins(InvocationPlugins plugins, NodeIntrinsicPluginFactory.InjectionProvider injection) {
        plugins.register(new Plugin_ThreadSubstitutions_threadIsInterruptedStub(injection), org.graalvm.compiler.hotspot.replacements.ThreadSubstitutions.class, "threadIsInterruptedStub", org.graalvm.compiler.core.common.spi.ForeignCallDescriptor.class, java.lang.Thread.class, boolean.class);
    }
}
