...
public class AMD64NodeMatchRules_MatchStatementSet implements MatchStatementSet {
    ...
    public List<MatchStatement> statements() {
        ...
        List<MatchStatement> statements = Collections.unmodifiableList(Arrays.asList(
            ...
            new MatchStatement("integerTestBranchMemory", new MatchPattern(IfNode.class, null, new MatchPattern(IntegerTestNode.class, null, new MatchPattern(VolatileReadNode.class, "access", true, false), new MatchPattern("value", false, false), IntegerTestNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_integerTestBranchMemory.instance, integerTestBranchMemory_arguments),
            new MatchStatement("integerTestBranchMemory", new MatchPattern(IfNode.class, null, new MatchPattern(IntegerTestNode.class, null, new MatchPattern("value", false, false), new MatchPattern(VolatileReadNode.class, "access", true, false), IntegerTestNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_integerTestBranchMemory.instance, integerTestBranchMemory_arguments),
            ...
            new MatchStatement("ifCompareMemory", new MatchPattern(IfNode.class, null, new MatchPattern(IntegerEqualsNode.class, "compare", new MatchPattern("value", false, false), new MatchPattern(VolatileReadNode.class, "access", true, false), IntegerEqualsNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_ifCompareMemory.instance, ifCompareMemory_arguments),
            new MatchStatement("ifCompareMemory", new MatchPattern(IfNode.class, null, new MatchPattern(IntegerEqualsNode.class, "compare", new MatchPattern(VolatileReadNode.class, "access", true, false), new MatchPattern("value", false, false), IntegerEqualsNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_ifCompareMemory.instance, ifCompareMemory_arguments),
            new MatchStatement("ifCompareMemory", new MatchPattern(IfNode.class, null, new MatchPattern(IntegerLessThanNode.class, "compare", new MatchPattern("value", false, false), new MatchPattern(VolatileReadNode.class, "access", true, false), IntegerLessThanNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_ifCompareMemory.instance, ifCompareMemory_arguments),
            new MatchStatement("ifCompareMemory", new MatchPattern(IfNode.class, null, new MatchPattern(IntegerLessThanNode.class, "compare", new MatchPattern(VolatileReadNode.class, "access", true, false), new MatchPattern("value", false, false), IntegerLessThanNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_ifCompareMemory.instance, ifCompareMemory_arguments),
            new MatchStatement("ifCompareMemory", new MatchPattern(IfNode.class, null, new MatchPattern(IntegerBelowNode.class, "compare", new MatchPattern("value", false, false), new MatchPattern(VolatileReadNode.class, "access", true, false), IntegerBelowNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_ifCompareMemory.instance, ifCompareMemory_arguments),
            new MatchStatement("ifCompareMemory", new MatchPattern(IfNode.class, null, new MatchPattern(IntegerBelowNode.class, "compare", new MatchPattern(VolatileReadNode.class, "access", true, false), new MatchPattern("value", false, false), IntegerBelowNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_ifCompareMemory.instance, ifCompareMemory_arguments),
            ...
            new MatchStatement("ifCompareMemory", new MatchPattern(IfNode.class, null, new MatchPattern(FloatEqualsNode.class, "compare", new MatchPattern("value", false, false), new MatchPattern(VolatileReadNode.class, "access", true, false), FloatEqualsNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_ifCompareMemory.instance, ifCompareMemory_arguments),
            new MatchStatement("ifCompareMemory", new MatchPattern(IfNode.class, null, new MatchPattern(FloatEqualsNode.class, "compare", new MatchPattern(VolatileReadNode.class, "access", true, false), new MatchPattern("value", false, false), FloatEqualsNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_ifCompareMemory.instance, ifCompareMemory_arguments),
            ...
            new MatchStatement("ifCompareMemory", new MatchPattern(IfNode.class, null, new MatchPattern(FloatLessThanNode.class, "compare", new MatchPattern("value", false, false), new MatchPattern(VolatileReadNode.class, "access", true, false), FloatLessThanNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_ifCompareMemory.instance, ifCompareMemory_arguments),
            new MatchStatement("ifCompareMemory", new MatchPattern(IfNode.class, null, new MatchPattern(FloatLessThanNode.class, "compare", new MatchPattern(VolatileReadNode.class, "access", true, false), new MatchPattern("value", false, false), FloatLessThanNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_ifCompareMemory.instance, ifCompareMemory_arguments),
            ...
            new MatchStatement("ifCompareMemory", new MatchPattern(IfNode.class, null, new MatchPattern(PointerEqualsNode.class, "compare", new MatchPattern("value", false, false), new MatchPattern(VolatileReadNode.class, "access", true, false), PointerEqualsNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_ifCompareMemory.instance, ifCompareMemory_arguments),
            new MatchStatement("ifCompareMemory", new MatchPattern(IfNode.class, null, new MatchPattern(PointerEqualsNode.class, "compare", new MatchPattern(VolatileReadNode.class, "access", true, false), new MatchPattern("value", false, false), PointerEqualsNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_ifCompareMemory.instance, ifCompareMemory_arguments),
            ...
            new MatchStatement("ifCompareMemory", new MatchPattern(IfNode.class, null, new MatchPattern(ObjectEqualsNode.class, "compare", new MatchPattern("value", false, false), new MatchPattern(VolatileReadNode.class, "access", true, false), ObjectEqualsNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_ifCompareMemory.instance, ifCompareMemory_arguments),
            new MatchStatement("ifCompareMemory", new MatchPattern(IfNode.class, null, new MatchPattern(ObjectEqualsNode.class, "compare", new MatchPattern(VolatileReadNode.class, "access", true, false), new MatchPattern("value", false, false), ObjectEqualsNode_positions, true, true), IfNode_positions, true, false), MatchGenerator_ifCompareMemory.instance, ifCompareMemory_arguments),
            ...
            new MatchStatement("addMemory", new MatchPattern(AddNode.class, null, new MatchPattern("value", false, false), new MatchPattern(VolatileReadNode.class, "access", true, false), AddNode_positions, true, true), MatchGenerator_addMemory.instance, addMemory_arguments),
            new MatchStatement("addMemory", new MatchPattern(AddNode.class, null, new MatchPattern(VolatileReadNode.class, "access", true, false), new MatchPattern("value", false, false), AddNode_positions, true, true), MatchGenerator_addMemory.instance, addMemory_arguments),
            ...
            new MatchStatement("subMemory", new MatchPattern(SubNode.class, null, new MatchPattern("value", false, false), new MatchPattern(VolatileReadNode.class, "access", true, false), SubNode_positions, true, true), MatchGenerator_subMemory.instance, subMemory_arguments),
            ...
            new MatchStatement("mulMemory", new MatchPattern(MulNode.class, null, new MatchPattern("value", false, false), new MatchPattern(VolatileReadNode.class, "access", true, false), MulNode_positions, true, true), MatchGenerator_mulMemory.instance, mulMemory_arguments),
            new MatchStatement("mulMemory", new MatchPattern(MulNode.class, null, new MatchPattern(VolatileReadNode.class, "access", true, false), new MatchPattern("value", false, false), MulNode_positions, true, true), MatchGenerator_mulMemory.instance, mulMemory_arguments),
            ...
            new MatchStatement("andMemory", new MatchPattern(AndNode.class, null, new MatchPattern("value", false, false), new MatchPattern(VolatileReadNode.class, "access", true, false), AndNode_positions, true, true), MatchGenerator_andMemory.instance, andMemory_arguments),
            new MatchStatement("andMemory", new MatchPattern(AndNode.class, null, new MatchPattern(VolatileReadNode.class, "access", true, false), new MatchPattern("value", false, false), AndNode_positions, true, true), MatchGenerator_andMemory.instance, andMemory_arguments),
            ...
            new MatchStatement("orMemory", new MatchPattern(OrNode.class, null, new MatchPattern("value", false, false), new MatchPattern(VolatileReadNode.class, "access", true, false), OrNode_positions, true, true), MatchGenerator_orMemory.instance, orMemory_arguments),
            new MatchStatement("orMemory", new MatchPattern(OrNode.class, null, new MatchPattern(VolatileReadNode.class, "access", true, false), new MatchPattern("value", false, false), OrNode_positions, true, true), MatchGenerator_orMemory.instance, orMemory_arguments),
            ...
            new MatchStatement("xorMemory", new MatchPattern(XorNode.class, null, new MatchPattern("value", false, false), new MatchPattern(VolatileReadNode.class, "access", true, false), XorNode_positions, true, true), MatchGenerator_xorMemory.instance, xorMemory_arguments),
            new MatchStatement("xorMemory", new MatchPattern(XorNode.class, null, new MatchPattern(VolatileReadNode.class, "access", true, false), new MatchPattern("value", false, false), XorNode_positions, true, true), MatchGenerator_xorMemory.instance, xorMemory_arguments),
            ...
            new MatchStatement("signExtend", new MatchPattern(SignExtendNode.class, null, new MatchPattern(VolatileReadNode.class, "access", true, false), SignExtendNode_positions, true, true), MatchGenerator_signExtend.instance, signExtend_arguments),
            ...
            new MatchStatement("zeroExtend", new MatchPattern(ZeroExtendNode.class, null, new MatchPattern(VolatileReadNode.class, "access", true, false), ZeroExtendNode_positions, true, true), MatchGenerator_zeroExtend.instance, zeroExtend_arguments),
            ...
            new MatchStatement("narrowRead", new MatchPattern(NarrowNode.class, null, new MatchPattern(VolatileReadNode.class, "access", true, false), NarrowNode_positions, true, true), MatchGenerator_narrowRead.instance, narrowRead_arguments),
            ...
            new MatchStatement("signExtendNarrowRead", new MatchPattern(SignExtendNode.class, null, new MatchPattern(NarrowNode.class, "narrow", new MatchPattern(VolatileReadNode.class, "access", true, false), NarrowNode_positions, true, true), SignExtendNode_positions, true, true), MatchGenerator_signExtendNarrowRead.instance, signExtendNarrowRead_arguments),
            ...
            new MatchStatement("floatConvert", new MatchPattern(FloatConvertNode.class, null, new MatchPattern(VolatileReadNode.class, "access", true, false), FloatConvertNode_positions, true, true), MatchGenerator_floatConvert.instance, floatConvert_arguments),
            ...
            new MatchStatement("reinterpret", new MatchPattern(ReinterpretNode.class, null, new MatchPattern(VolatileReadNode.class, "access", true, false), ReinterpretNode_positions, true, true), MatchGenerator_reinterpret.instance, reinterpret_arguments)
        ));
        // Checkstyle: resume
        return statements;
    }
